...
extern int fscrypt_get_encryption_key(struct fscrypt_info *crypt_info,
					struct fscrypt_key *key);
extern int fscrypt_get_encryption_key_classified(struct fscrypt_info *crypt_info,
					struct fscrypt_key *key);
extern int fscrypt_get_encryption_kek(struct fscrypt_info *crypt_info,
